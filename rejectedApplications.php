...
<body>  
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16"><b>Rejected Adoption Applications</b> <span class="w3-tag w3-Light-Blue w3-round-medium"><?php echo "$rejectedApplicationCount"; ?></span> </h3>
            <!-- <h4><span class="w3-tag w3-Green w3-round-medium"><?php echo $pendingApplicationCount?> Pending Applications </span>  </h4>  -->
            <!-- <div class="form-group">
                <select class="form-control" id="selectedApplicationType" onchange="updateTable()">
                    <option>Pending (<?php echo $pendingApplicationCount?>)</option>
                    <option>Approved (<?php echo $approvedApplicationCount?>)</option>
                    <option>Rejected (<?php echo $rejectedApplicationCount?>)</option>
                </select>
            </div> -->
                ...
                <tbody id="populateTable">  
                    <?php
                        ...
                        if($applicationRetrieveStatus == "success"){
                            if(!empty($rejectedApplicationArray)){
                                foreach($rejectedApplicationArray as $eachApplication){
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='staff_view_application.php?appID=$eachApplication->ApplicationID&from=rejected'><b><u>View</u></b></a></td>
                                    </tr>
                                    ";
                                }
                            }
