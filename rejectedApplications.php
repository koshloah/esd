...
<body>  
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16"><span class="w3-tag w3-Light-Blue w3-round-medium"><?php echo "$rejectedApplicationCount"; ?></span> <b> Rejected Adoption Applications</b></h3>
