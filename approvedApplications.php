...
<body>
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16"><b>Approved Adoption Applications</b> <span class="w3-tag w3-Light-Blue w3-round-medium"><?php echo "$approvedApplicationCount"; ?></span> </h3>
                ...
                <tbody id="populateTable">  
                    <?php
                        ...
                        if($applicationRetrieveStatus == "success"){
                            if(!empty($approvedApplicationArray)){
                                foreach($approvedApplicationArray as $eachApplication){
                                    ...
                                    <tr class='w3-hover-opacity'>
                                        ...
                                        <td><a href='staff_view_application.php?appID=$eachApplication->ApplicationID&from=approved'><b><u>View</u></b></a></td>
                                    </tr>
                                    ";
                                }
                            }
