      ...
      foreach($availableDogArray as $eachAvailableDog){
        ...
        echo "<div class='w3-col l3 m6 w3-margin-bottom'>
            <div class='w3-display-container'>
                ...
                <a href='viewdog.php?dogid=$eachAvailableDog->id'><img src='$eachAvailableDog->pic1' class='w3-hover-sepia' style='width:100%; height:280px; border-radius: 4%; object-fit: cover;'></a>
            </div>
        </div>";
      }
      ?>
