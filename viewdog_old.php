...
<html>
<body>
    <div class="w3-container w3-content w3-center" style="margin-top:60px; max-width: 500px;">

        <div class="w3-container">
            <img src=<?php echo $dogPic1?> height="300" width="300" alt="Image 1" style="border-radius: 4%;" class="w3-left">
            ...
            <form action="adoptionform.php" method="GET">
                ...
                <button class="w3-button w3-black w3-section w3-left" type="submit">Adopt <?php echo $dogName; ?> <i class="fa fa-paw"></i></button>
            </form>
